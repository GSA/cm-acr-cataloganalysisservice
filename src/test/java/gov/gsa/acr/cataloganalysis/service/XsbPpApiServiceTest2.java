...
class XsbPpApiServiceTest2 {
    ...
    void setUpBeforeEach(){
        when(apiConfig.getHostport()).thenReturn(String.format("http://bogus"));
    ...
    @Test
    @DisplayName("Test retry logic for unreachable server because of DNS lookup failure")
    void getAuthToken() {
